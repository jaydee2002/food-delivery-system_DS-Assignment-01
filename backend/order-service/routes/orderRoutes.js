...
// Restaurant Admin
router.get('/restaurant/:id/pending', restaurantAdminAuthMiddleware, getPending);
router.get('/restaurant/:id/preparing', restaurantAdminAuthMiddleware, getPrepare);
...
router.get('/restaurant/:id/delivered', restaurantAdminAuthMiddleware, getDelivered);
